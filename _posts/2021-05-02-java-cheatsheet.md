...
>This post is modified to fit my needs. **The original source is in the following [link](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/languages/java.md)**
